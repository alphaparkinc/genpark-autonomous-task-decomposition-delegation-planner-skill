# genpark-autonomous-task-decomposition-delegation-planner-skill
...
> **GenPark AI Agent Skill** -- Multi-step autonomous agent workflow decomposition & task planner (Grok Bot style)
